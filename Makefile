...
protos-generate: ## Generate protos
	python3 -m grpc_tools.protoc -I ./permissions-protos --python_out=./insights-service/app --grpc_python_out=./insights-service/app ./permissions-protos/permission.proto
